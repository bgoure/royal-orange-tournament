 ...
 * 12- and 13-team use feeder-wired draw maps through Round 4, then open redraw slots (A/B endgame).
 */
...
import { OBA12_GAME } from "@/lib/services/oba-de-12";
...
/** Round 1–7 column labels for the 12-team draw map. */
export function oba12DrawRoundColumns(): string[] {
  return ["Round 1", "Round 2", "Round 3", "Round 4", "Round 5", "Round 6", "Round 7"];
}

export function oba13DrawRoundColumns(): string[] {
  return [
    "Round 1",
    "Round 2",
    "Round 3",
...
/**
 * 12-team OBA double-elim draw map (written workbook).
 * teamIds[0] = Team 1 (plays Game 1 — no Round 1 bye). Remaining teams pair sequentially into Games 1–6.
 * Rounds 1–4 are fully feeder-wired, including G19 (W10 vs W16). W10 sits Round 3 with no bye card.
 * Round 5 seats are open for admin rematch-avoid. Bracket A (2 remain) / B (3 remain) are both created.
 */
export function gamesForOba12Draw(draw: string[]): GameDef[] {
  const [t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12] = draw;
  if (!t1 || !t2 || !t3 || !t4 || !t5 || !t6 || !t7 || !t8 || !t9 || !t10 || !t11 || !t12) {
    throw new Error("12-team DE requires exactly 12 teams.");
  }
  const g = OBA12_GAME;
  return [
    {
    ...
    },
    {
      ...
      roundName: "Round 1",
      roundType: BracketRoundType.WINNERS,
      home: { kind: "team", teamId: t7 },
      away: { kind: "team", teamId: t8 },
      gameNumber: g.G4,
    },
    {
      key: "G5",
      ...
      roundName: "Round 1",
      roundType: BracketRoundType.WINNERS,
      home: { kind: "team", teamId: t9 },
      away: { kind: "team", teamId: t10 },
      gameNumber: g.G5,
    },
    {
      key: "G6",
      ...
      roundName: "Round 1",
      roundType: BracketRoundType.WINNERS,
      home: { kind: "team", teamId: t11 },
      away: { kind: "team", teamId: t12 },
      gameNumber: g.G6,
    },
    {
      key: "G7",
    ...
    },
    {
      ...
      roundName: "Round 3",
      roundType: BracketRoundType.LOSERS,
      home: { kind: "loser", of: "G11" },
      away: { kind: "loser", of: "G12" },
      gameNumber: g.G15,
    },
    {
      key: "G16",
      ...
      roundName: "Round 3",
      roundType: BracketRoundType.WINNERS,
      home: { kind: "winner", of: "G11" },
      away: { kind: "winner", of: "G12" },
      gameNumber: g.G16,
    },
    {
      key: "G17",
      ...
      roundName: "Round 4",
      roundType: BracketRoundType.LOSERS,
      home: { kind: "winner", of: "G13" },
      away: { kind: "winner", of: "G14" },
      gameNumber: g.G17,
    },
    {
      key: "G18",
      ...
      roundName: "Round 4",
      roundType: BracketRoundType.LOSERS,
      home: { kind: "winner", of: "G15" },
      away: { kind: "loser", of: "G16" },
      gameNumber: g.G18,
    },
    {
      key: "G19",
      ...
      roundName: "Round 4",
      roundType: BracketRoundType.WINNERS,
      home: { kind: "winner", of: "G10" },
      away: { kind: "winner", of: "G16" },
      gameNumber: g.G19,
    },
    {
      key: "G20",
    ...
    },
    {
      ...
      roundName: "Round 6",
      roundType: BracketRoundType.WINNERS,
      home: { kind: "winner", of: "G20" },
      away: { kind: "winner", of: "G21" },
      gameNumber: g.G22A,
    },
    {
      key: "G22B",
    ...
    },
    {
      ...
      roundName: "Round 7",
      roundType: BracketRoundType.FINAL,
      home: { kind: "winner", of: "G22A" },
      away: { kind: "loser", of: "G22A" },
      gameNumber: g.G23A,
    },
    {
      key: "G23B",
      ...
      roundName: "Round 7",
      roundType: BracketRoundType.FINAL,
      home: { kind: "winner", of: "G22B" },
      away: { kind: "winner", of: "BYE_R6" },
      gameNumber: g.G23B,
    },
  ];
}
...
/**
 * 13-team OBA double-elim draw map (written workbook, not the filled poster's R2 swap).
 * teamIds[0] = Team 1 (Round 1 bye). Remaining 12 pair sequentially into Games 1–6.
 * Rounds 1–4 are fully feeder-wired. Round 5+ seats are open for admin redraw.
 * Bracket A (23A/24A/25A) and Bracket B (23B/24B/25B) are both created; unused branch is cancelled later.
 */
export function gamesForOba13Draw(draw: string[]): GameDef[] {
  const [t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13] = draw;
  if (!t1 || !t2 || !t3 || !t4 || !t5 || !t6 || !t7 || !t8 || !t9 || !t10 || !t11 || !t12 || !t13) {
    throw new Error("13-team DE requires exactly 13 teams.");
  }
  const g = OBA13_GAME;
  return [
    // Round 1 — Team 1 bye (implicit into G10)
    {
      key: "G1",
      roundGroup: "R1",
      roundName: "Round 1",
      roundType: BracketRoundType.WINNERS,
      home: { kind: "team", teamId: t2 },
      away: { kind: "team", teamId: t3 },
      gameNumber: g.G1,
    },
    {
      key: "G2",
      ...
      roundName: "Round 1",
      roundType: BracketRoundType.WINNERS,
      home: { kind: "team", teamId: t4 },
      away: { kind: "team", teamId: t5 },
      gameNumber: g.G2,
    },
    {
      key: "G3",
      ...
      roundName: "Round 1",
      roundType: BracketRoundType.WINNERS,
      home: { kind: "team", teamId: t6 },
      away: { kind: "team", teamId: t7 },
      gameNumber: g.G3,
    },
    {
      key: "G4",
      ...
      roundName: "Round 1",
      roundType: BracketRoundType.WINNERS,
      home: { kind: "team", teamId: t8 },
      away: { kind: "team", teamId: t9 },
      gameNumber: g.G4,
    },
    {
      key: "G5",
      ...
      roundName: "Round 1",
      roundType: BracketRoundType.WINNERS,
      home: { kind: "team", teamId: t10 },
      away: { kind: "team", teamId: t11 },
      gameNumber: g.G5,
    },
    {
      key: "G6",
      ...
      roundName: "Round 1",
      roundType: BracketRoundType.WINNERS,
      home: { kind: "team", teamId: t12 },
      away: { kind: "team", teamId: t13 },
      gameNumber: g.G6,
    },
    // Round 2 — W1 bye (implicit into G16)
    {
      key: "G7",
      roundGroup: "R2",
      roundName: "Round 2",
    ...
    // Round 4 — L13/L14/L15 out; W13 bye
    {
      key: "G18",
      roundGroup: "R4",
      roundName: "Round 4",
      roundType: BracketRoundType.LOSERS,
      home: { kind: "winner", of: "G14" },
      away: { kind: "winner", of: "G15" },
      gameNumber: g.G18,
    },
    {
      key: "G19",
      ...
      roundName: "Round 4",
      roundType: BracketRoundType.LOSERS,
      home: { kind: "loser", of: "G16" },
      away: { kind: "loser", of: "G17" },
      gameNumber: g.G19,
    },
    {
      key: "G20",
      ...
      roundName: "Round 4",
      roundType: BracketRoundType.WINNERS,
      home: { kind: "winner", of: "G16" },
      away: { kind: "winner", of: "G17" },
      gameNumber: g.G20,
    },
    // Round 5 — redraw (admin)
    {
      key: "BYE_R5",
      roundGroup: "R5",
      roundName: "Round 5",
    ...
    // Round 6 — Bracket A and B both pre-created
    {
      key: "BYE_R6",
      roundGroup: "R6",
      roundName: "Round 6",
    ...
    },
    {
      ...
      roundName: "Round 7",
      roundType: BracketRoundType.FINAL,
      home: { kind: "winner", of: "G23B" },
      away: { kind: "winner", of: "G24B" },
      gameNumber: g.G25B,
    },
    // Round 8 — if-necessary (A, 2 remain) or final vs R7 bye (A, 3 remain)
    {
      key: "G25A",
      roundGroup: "R8",
      roundName: "Round 8",
      roundType: BracketRoundType.FINAL,
      home: { kind: "winner", of: "G24A" },
      away: { kind: "winner", of: "BYE_R7" },
      gameNumber: g.G25A,
    },
  ];
}
...
function gameDefsForPreset(key: ObaDePresetKey, drawOrder: string[]): GameDef[] {
  switch (key) {
    ...
    case "oba_de_12":
      return gamesForOba12Draw(drawOrder);
    case "oba_de_13":
      return gamesForOba13Draw(drawOrder);
    default:
 ...
 * For seeded maps (5–7): teamIds[0] = seed 1 (strongest).
 * For 4-team, 12-team, and 13-team: teamIds[0] = first drawn (Round 1 bye when the map awards one).
 */
export async function createObaDeBracket(opts: CreateObaDeBracketOptions): Promise<string> {
  ...
  // 12- and 13-team are feeder-wired through Round 4; R5+ open slots are resolved in oba-de-redraw.
