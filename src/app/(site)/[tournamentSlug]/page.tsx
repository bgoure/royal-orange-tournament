...
function QuickLinkCard({ href, label, description, icon }: { href: string; label: string; description: string; icon: ReactNode }) {
  return (
    <Link
      href={href}
      className="group flex min-h-[48px] flex-col items-center justify-center gap-1.5 rounded-2xl border border-zinc-200 border-l-2 border-l-royal/50 bg-white p-4 text-center shadow-sm transition-all hover:border-royal-200 hover:shadow-md active:scale-[0.98]"
    >
