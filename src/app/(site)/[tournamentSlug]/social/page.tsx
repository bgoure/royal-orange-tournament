          ...
          return (
            <li key={s.key}>
              <Link
                ...
                className="group flex min-h-[48px] items-start gap-3 rounded-2xl border border-zinc-200 border-l-2 border-l-royal bg-white p-4 shadow-sm transition-all hover:border-royal-200 hover:shadow-md active:scale-[0.99]"
              >
