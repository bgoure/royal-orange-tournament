      ...
      <ul className="grid gap-3 sm:grid-cols-2">
        {links.map((item) => (
          <li key={item.href}>
            <Link
              href={item.href}
              className="group flex min-h-[48px] flex-col justify-center rounded-2xl border border-zinc-200 border-l-royal bg-white px-4 py-3 shadow-sm transition-all active:scale-[0.99] hover:border-royal-200 hover:shadow-md"
            >
