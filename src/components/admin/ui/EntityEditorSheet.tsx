...
type Props = {
  ...
  /**
   * Optional status chip in the sticky header (e.g. “Unsaved changes”).
   */
  status?: ReactNode;
  /**
      ...
      <Drawer.Portal>
        ...
        <Drawer.Content
          ...
          className={[
            ...
            "fixed z-[80] flex flex-col overflow-hidden bg-white outline-none",
            isRight
        ...
        >
          ...
          {!isRight ? (
            <div className="flex shrink-0 justify-center pt-3" aria-hidden>
              <Drawer.Handle className="h-1.5 w-12 rounded-full bg-zinc-300" />
            </div>
          ) : null}
          ...
          {/* Scrollable form body — no horizontal scroll */}
          <div className="min-h-0 flex-1 overflow-x-hidden overflow-y-auto px-5 pb-4 pt-5">
            {children}
